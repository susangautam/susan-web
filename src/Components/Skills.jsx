const Skills = () => {
  ...
  return (
    <section id="skills" className="py-10 bg-gray-200">
      <div className="container mx-auto text-center">
        ...
        <div className="flex justify-center mt-6 flex-wrap gap-6">
          {skills.map((skill, index) => (
            <div
              key={index}
              className="flex flex-col items-center bg-accent py-4 px-6 rounded-lg shadow-md transition duration-300 transform hover:scale-105 hover:shadow-lg"
            >
              <img
                src={skill.logo}
                alt={`${skill.name} logo`}
