          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start space-x-6">
                <a href="https://www.facebook.com/xuxantgtm/" className="text-gray-600 hover:text-secondary transition-colors">
                  <FontAwesomeIcon icon={faFacebook} size="lg" />
                </a>
                <a href="https://www.instagram.com/xuxant_gtm/?next=%2F" className="text-gray-600 hover:text-secondary transition-colors">
                  <FontAwesomeIcon icon={faInstagram} size="lg" />
                </a>
                <a href="https://www.linkedin.com/in/susan-gautam-20502b311/" className="text-gray-600 hover:text-secondary transition-colors">
            ...
            <div className="text-center md:text-left">
              <h3 className="text-xl font-semibold mb-4 text-gray-600">Quick Links</h3>
            ...
            <div className="text-center md:text-left">
              <h3 className="text-xl font-semibold mb-4 text-gray-600">Contact : </h3>
